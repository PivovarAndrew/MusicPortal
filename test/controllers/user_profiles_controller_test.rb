...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { edit: @user_profile.edit, show: @user_profile.show, update: @user_profile.update } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { edit: @user_profile.edit, show: @user_profile.show, update: @user_profile.update } }
